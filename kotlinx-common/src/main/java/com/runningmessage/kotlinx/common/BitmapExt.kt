...
//@formatter:off
const val CORNER_LEFT_TOP       = 0b0001.toLong()
const val CORNER_RIGHT_TOP      = 0b0010.toLong()
const val CORNER_RIGHT_BOTTOM   = 0b0100.toLong()
const val CORNER_LEFT_BOTTOM    = 0b1000.toLong()
const val CORNER_ALL            = 0b1111.toLong()
//@formatter:on
...
@IntDef(
        flag = true,
        value = [CORNER_ALL, CORNER_LEFT_TOP, CORNER_RIGHT_TOP, CORNER_RIGHT_BOTTOM, CORNER_LEFT_BOTTOM]
)
...
/***
 * create a new rounded corner bitmap, basing on the current bitmap
 */
@JvmOverloads
fun Bitmap?.createRoundedCornerBitmap(
        @CornerPosition corners: Long = CORNER_ALL,
        roundPx: Float? = null,
        outputWidth: Int = 0,
        outputHeight: Int = 0,
    ...
    try {
        ...
        if ((corners and CORNER_ALL) == 0L) return bitmap
